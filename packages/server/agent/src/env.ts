...
const schema = z.object({
  ...
  OPENCLAW_DEMO_MODEL: z.string().default('deepseek/deepseek-v4-flash'),
  OPENCLAW_REQUEST_TIMEOUT_MS: z.coerce.number().int().positive().default(240_000),
...
export const env = {
  ...
  openclawRequestTimeoutMs: parsed.OPENCLAW_REQUEST_TIMEOUT_MS,
