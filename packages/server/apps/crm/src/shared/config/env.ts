...
const EnvSchema = z.object({
  ...
  CRM_DB_USER: z.string().default('postgres'),
  CRM_DB_PASSWORD: z.string().default('postgres'),
  CRM_DB_NAME: z.string().default('nba'),
  CRM_DB_SCHEMA: z.string().default('crm'),
